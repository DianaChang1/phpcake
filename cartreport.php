...
if(isset($_POST["customername"]) && ($_POST["customername"]!="")){
	...
	if(!is_object($cart)) $cart = new myCart1();
	//購物車結束	
	//新增訂單資料
	$query = "INSERT INTO orders (total ,deliverfee ,grandtotal ,customername ,customeremail ,customeraddress ,customerphone ,paytype) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
...
window.location.href="productall.php";
</script>